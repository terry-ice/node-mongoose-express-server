/*
 * @Author: terry
 * @Date: 2019-05-12 20:29:30
 * @Last Modified by: https://github.com/terry-ice
 * @Last Modified time: 2019-05-12 21:10:53
 */
import config from '../config';
import {handleRequest, handleError,handleSuccess,} from '../utils/handle';
...
articleCtrl.list.GET = (req, res) => {
	...
	let { page, per_page, state, keyword, category, category_slug, tag, tag_slug, date, hot } = req.query;
