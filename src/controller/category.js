/*
 * @Author: terry
 * @Date: 2019-05-12 20:40:46
 * @Last Modified by: https://github.com/terry-ice
 * @Last Modified time: 2019-05-12 20:56:00
 */
...
// export
const list = (req, res) => { handleRequest({ req, res, controller: categoryCtrl.list })};
const item = (req, res) => { handleRequest({ req, res, controller: categoryCtrl.item })};
